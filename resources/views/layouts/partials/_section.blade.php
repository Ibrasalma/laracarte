            		...
            		<div class="col-lg-6 col-md-6">
             			<aside>
							...
							<div class="content-footer">
								<img class="user-small-img" src="{{ asset('/images/logo.png') }}">
			                    ...
			                    <div class="user-ditels">
			                    	<div class="user-img"><img src="{{ asset('/images/logo.png') }}" class="img-responsive"></div>
        ...
        <!--=====================
          ...
          ======================-->
             	<div class="widget-sidebar">
                 	...
                 	<button class="categories-btn">Audio <span class="pull-right">13</span></button>
                 	<button class="categories-btn">Blog <span class="pull-right">13</span></button>
               		<button class="categories-btn">Gallery <span class="pull-right">13</span></button>
               		<button class="categories-btn">Images <span class="pull-right">13</span></button>
             	</div>  
